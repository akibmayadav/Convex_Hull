...
function recall(convex_hull_arrays,color_mesh,speed,spread,line)
{
    ...
    {
        var x_coord = convex_hull_arrays[t].x + spread*Math.sin(t*progress*Math.PI/speed);
        var y_coord = convex_hull_arrays[t].y + spread*Math.cos(t*progress*Math.PI/speed);
    ...
    convex_hull_points = convex_hull(points_array);
    ...
    triangles = THREE.Shape.Utils.triangulateShape( convex_hull_points, holes );
